...
const Message = props => {
    ...
    let senderUsername = ''
    try {
        senderUsername = props.sending ? props.creds.userName : props.message.sender.username
    } catch(e) {
    ...
    try{
        isTurnEnd = !props.nextMessage || props.nextMessage.sender.username !== senderUsername
    } catch(e) {
        console.error(e)
        isTurnEnd = false
    }
